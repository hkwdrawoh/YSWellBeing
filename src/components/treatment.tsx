...
export default function CurrentTreatment(props: {
    ...
    return <>
        <div className="grid grid-cols-4">
            <button
                className="text-center my-auto grid items-center justify-center gap-x-4 gap-y-8 bg-primary rounded-lg border-background1 border-opacity-50 border-2 w-full"
        ...
        <div className="bg-background1 border-primary border-2 grid grid-cols-10 gap-y-2 mt-4 px-2 pt-4 pb-6 items-center">
